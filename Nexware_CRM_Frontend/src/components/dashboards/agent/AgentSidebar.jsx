...
export default function AgentSidebar({ close }) {
  const location = useLocation();
  
  // Define Agent-specific routes
  const links = [
    ...
    { to: "/agent/orders", label: "My Orders", icon: ShoppingCart },
    { to: "/agent/profile", label: "My Profile", icon: UserPen },
  ];
      ...
      <div className="p-6">
        ...
        <div className="flex items-center justify-between mb-10">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-white font-semibold text-sm">AGENT</div>
              <div className="text-[#BFD3FF] text-xs">Sales Panel</div>
            </div>
          </div>
