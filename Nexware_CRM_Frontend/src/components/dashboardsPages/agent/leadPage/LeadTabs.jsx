...
const LeadTabs = ({ activeTab, setActiveTab, counts = {} }) => {
  ...
  return (
    <div className="w-full overflow-x pb-1" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
      {/* Container: Glassy background */}
      <div className="inline-flex p-1 bg-slate-100/50 border border-slate-200 rounded-xl gap-1 min-w-full sm:min-w-0">
