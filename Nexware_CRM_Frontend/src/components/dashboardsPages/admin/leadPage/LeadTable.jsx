          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-slate-50 border-b border-slate-200">
                ...
                <th className="px-6 py-4 text-[11px] font-bold uppercase tracking-wider text-slate-500 w-[30%]">Lead Name</th>
                <th className="px-6 py-4 text-[11px] font-bold uppercase tracking-wider text-slate-500 w-[25%]">Contact</th>
                ...
                {/* Removed the Edit Column Header here */}
              </tr>
            </thead>
            <tbody className="divide-y divide-slate-100">
              {displayedLeads.map((lead, index) => (
                <motion.tr
                  key={lead._id || index}
                  onClick={() => setSelectedLeadId(lead._id || lead.id)} // Added Click Handler to Row
                  initial={{ opacity: 0, y: 10 }}
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ delay: index * 0.05 }}
                  className="group hover:bg-slate-50/80 transition-all duration-200 cursor-pointer" // Added cursor-pointer
                >
                  ...
                  {/* Removed the <td> containing the Edit button */}
                </motion.tr>
              ))}
