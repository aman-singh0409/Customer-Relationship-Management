  ...
  return (
    <div className="flex flex-col items-center gap-5">
      <div className="relative group">
        <div className="w-32 h-32 rounded-full flex items-center justify-center border-4 border-white shadow-xl overflow-hidden bg-gray-100">
          {avatarUrl ? (
      ...
      {/* Buttons only appear in Edit Mode (Clean UI) */}
      {isEditing && (
      ...
      {isEditing && <p className="text-xs text-gray-400">Max size: 800KB</p>}
    </div>
  );
};
