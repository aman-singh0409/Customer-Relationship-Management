...
import AgentSidebar from "../components/dashboards/agent/AgentSidebar";
import AgentNavbar from "../components/dashboards/agent/AgentNavbar";
  ...
  return (
    <div className="flex bg-gray-100 min-h-screen">
      ...
      <div
        ...
        `}
      >
        <AgentSidebar close={() => setOpen(false)} />
      </div>
